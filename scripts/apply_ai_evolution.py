...
"""
    ...
    # 3. Replace handleAI, aiShopAI, aiSelectSkill
    handle_ai_pattern = re.compile(r'    handleAI\(dt\).*?(?=    update\(dt\))', re.DOTALL)
...
"""
    ...
    # 5. Inject TeamBrains into startGame()
    ...
    # 6. Inject TeamBrains update in gameLoop()
    ...
    # 7. Modify window.AIChat to add triggerOrderChat and triggerStateChat
    ...
    triggerOrderChat: function(commander, orderType, faction) {
        ...
        // PING SYSTEM: Draw ping effect on field!
...
"""
    ...
    # 8. Add probability filter in addChat based on personality
...
"""
    ...
    # 9. Modify Hero.draw to draw 👑 on commander
    ...
    # Replacing Joker's bet 100 to 500
    ...
    print("AI Evolution Update applied successfully!")
