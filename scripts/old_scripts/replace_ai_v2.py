...
window.AIChat = {
    ...
    patterns: {
        kill: [
            "컷~ ㅅㄱ", "벌레컷ㅋㅋ", "아 달다~", "?? 쟤 뭐함?", "개못하네 진짜ㅋㅋ", "꺼어어억", "잘가시고~", "딜량 실화냐?", "이게 게임이지", "나이스!", "캐리머신 ON", "바닥 쓸고가네ㅋㅋ", "마우스 발로함?", "AI한테도 지냐?", "응 컷~", "너무 달달하고~", "수고링", "이걸 사네ㅋㅋ 나이스", "막타 개꿀", "센스 미쳤고", "피지컬 차이ㅋㅋ", "손가락 몇개심?", "걍 지우개네 ㅋㅋ", "숨쉬듯 킬먹노", "아 너무 쉽다"
        ],
        death: [
            "아 ㄲㅂ", "억까 ㅈ대네", "아니 백업 좀;;", "렉걸림 ㅈㅅ", "운빨 망겜 수준", "ㅅㅂ 이게 죽어?", "아니 피 1남았는데", "우리팀 뭐함?", "정글차이 개심하네", "아 핑킥 ㅈㅅ", "마우스 선 뽑힘", "저게 사네 ㅡㅡ", "밸런스 꼬라지", "아니 내 킬인데", "힐 좀 주지;;", "아 눈부셔", "손 풀고 있음", "봐준거임ㅋㅋ", "진짜 억까 너무심하네", "아 샷건마렵네", "아니 팀원들 왜구경함?", "이건 억까지 ㅅㅂ", "아니 딜 왜저래", "한대충 혐오스럽네", "팀운 ㅈㅈ"
        ],
        team_fight_win: [
            "다 닦았죠? ㅅㄱ", "나이스 ㅋㅋ", "캐리 개꿀", "우물 대기하셈", "서렌 치셈 걍ㅋㅋ", "오합지졸이네 아주", "팀워크 미쳤다", "이게 팀이지", "걍 밀죠 ㄱㄱ", "바론이나 먹죠", "게임 ㅈㄴ쉽네", "개압살ㅋㅋ", "차이 너무나고~", "전광판 싹 비웠고", "넥서스 밀자", "오픈해라 걍", "겜 끝났네 ㅅㄱ", "너무 압도적인데", "벌레들 소탕 완료", "아 달달하다"
        ],
        team_fight_lose: [
            "아니 딜 왜저럼", "우리팀 딜러들 다어디감?", "포지션 개에반데", "서렌 치자 걍", "아니 왜 한타를 지금함?", "이걸 지네;;", "진짜 팀운 ㅈ같다", "아니 스킬 다빠졌는데 왜들어감?", "답답하네 진짜", "걍 우물에 있어라", "아~ 눈물나네", "이게 게임이냐", "왜 다 던짐?", "아이고 의미없다", "이거 못막음 ㅅㄱ", "벌써 겜 터졌누"
        ],
        idle: [
            "아니 ㅅㅂ 맵 좀 보라고", "합류 ㅈㄴ 안하네", "쟤 뭐함? 겜안폰가", "빨리 좀 와라", "혼자 RPG하네", "구경났냐?", "지금 미드 뚫리는데 머함", "아 진짜 1인분만 하자", "왜 자꾸 짤림?", "진짜 속터지네", "제발 합류좀 ㅠㅠ", "아니 언제옴?", "언제까지 파밍만 할래", "라인 관리 ㅈ같이 하네", "빨리 센터 모이라고!!", "님들 겜 던짐?", "눈팅만 하냐", "아니 거기서 뭐해", "혼자 겜하냐고", "제발 같이좀 다니자"
        ],
        streak: [
        ...
        response: [
            "ㅇㅈ", "ㄹㅇㅋㅋ", "니가 할말은 아님", "ㅋㅋㅋ 개웃기네", "네 다음 벌레", "입만 살았네", "조용히좀 해라", "응 니얼굴", "팩트 묵직하고", "차단함 ㅅㄱ", "핑계는 ㅋㅋㅋ", "잘좀 해봐라", "싸우지마셈;;", "채팅칠 시간에 겜이나 해", "니가 젤 못해", "남탓 오지네", "ㅋㅋㅋㅋㅋ", "아 뼈맞음", "그만 싸워라 쫌", "둘다 똑같음 걍"
        ]
    },
    ...
    addChat: function(hero, msg) {
        ...
        // Tiki-taka logic
        if(Math.random() < 0.4) {
            this.pendingResponses.push({ timer: 1.0 + Math.random()*2, srcFaction: hero.faction, msgType: 'response' });
        }
    },
...
print("game.js AI V2 injected successfully")
